...
Consulta [docs/runbooks/mvp-esp32-test.md](docs/runbooks/mvp-esp32-test.md) para la prueba completa de MVP.
Consulta [docs/mvp-ai-bridge.md](docs/mvp-ai-bridge.md) para topics y payloads.
Consulta [docs/research/voice-painter-experience.md](docs/research/voice-painter-experience.md) para el módulo de voz, categorías emocionales simples y placeholders HeyGen.
Consulta [docs/research/heygen-painter-scripts.md](docs/research/heygen-painter-scripts.md) para los guiones temporales de cada pintor.
