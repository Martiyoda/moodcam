...
constexpr RobotServoConfig BASE_SERVO_CONFIG = {
  SERVO_BASE, "base", 26, true, -30, 180, 90, 0, false, DEFAULT_SAFE_SPEED
};
...
constexpr RobotServoConfig ELBOW_SERVO_CONFIG = {
  SERVO_ELBOW, "elbow", 33, true, 35, 150, 90, 0, false, DEFAULT_SAFE_SPEED
};

constexpr RobotServoConfig WRIST_SERVO_CONFIG = {
  SERVO_WRIST, "wrist", 32, true, 0, 120, 90, 0, false, DEFAULT_SAFE_SPEED
};
