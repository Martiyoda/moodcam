...
void pollockSplash(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90, 90, 90}, {90, 90 + span, 84, 96}, {90, 86, 90 + span, 84}, {90, 90 - span, 96, 92}, {90, 94, 90 - span, 88}};
...
void pollockDrip(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 82, 90 - span, 90}, {90, 86, 90, 90}, {90, 90, 90 + span, 90}};
...
void pollockRandomLines(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 82, 96}, {90, 96, 90 + span, 82}, {90, 90 + span, 86, 100}, {90, 84, 90 - span, 88}};
...
void pollockEnergeticShake(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 88, 92}, {90, 90 + span, 92, 88}, {90, 90 - span, 92, 92}, {90, 90 + span, 88, 88}};
