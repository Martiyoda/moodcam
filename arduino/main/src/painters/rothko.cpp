...
void rothkoBlock(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 82, 90}, {90, 90 + span, 82, 90}, {90, 90 + span, 94, 90}, {90, 90 - span, 94, 90}, {90, 90 - span, 106, 90}, {90, 90 + span, 106, 90}};
...
void rothkoLayer(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 88, 90}, {90, 90 + span, 88, 90}, {90, 90 + span, 96, 90}, {90, 90 - span, 96, 90}};
...
void rothkoSlowRectangle(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 84, 90}, {90, 90 + span, 84, 90}, {90, 90 + span, 104, 90}, {90, 90 - span, 104, 90}, {90, 90 - span, 84, 90}};
...
void rothkoSoftBlend(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 88, 88}, {90, 90 + span, 88, 92}, {90, 90 - span, 94, 92}, {90, 90 + span, 94, 88}};
