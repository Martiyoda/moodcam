...
void almaDots(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 86, 90}, {90, 90, 86, 90}, {90, 90 + span, 86, 90}, {90, 90 - span, 98, 90}, {90, 90, 98, 90}, {90, 90 + span, 98, 90}};
...
void almaMosaic(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 84, 88}, {90, 90, 86, 92}, {90, 90 + span, 84, 88}, {90, 90 + span, 98, 92}, {90, 90, 96, 88}, {90, 90 - span, 98, 92}};
  runAlmaPattern(poses, 6, speed, intensity, durationMs, pressure);
}
...
void almaRepeatedMarks(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90 - span, 88, 86}, {90, 90 - span / 3, 90, 94}, {90, 90 + span / 3, 88, 86}, {90, 90 + span, 90, 94}};
...
void almaColorRhythm(int speed, int intensity, int durationMs, int pressure) {
  ...
  const ServoPose poses[] = {{90, 90, 90 - span, 90}, {90, 90 + span, 90, 94}, {90, 90, 90 + span, 90}, {90, 90 - span, 90, 86}, {90, 90, 90 - span, 90}};
